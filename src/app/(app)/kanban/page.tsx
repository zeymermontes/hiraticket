...
export default async function KanbanPage() {
  ...
  const [orders, items, stages, areas, agents, sessions, catalog] = await Promise.all([
  ...
  return <KanbanBoard orders={orders} items={items} stages={stages} areas={areas} agents={agents} catalog={catalog} businessId={business.id} connected={isConnected(sessions)} productStages={business.product_stages ?? false} />;
}
