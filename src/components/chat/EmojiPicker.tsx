...
const DATA: { c: string; items: [string, string][] }[] = [
  ...
  { c: "Gestos", items: [
    ["👍", "bien like pulgar arriba thumbs up"], ["👎", "mal dislike pulgar abajo"], ["👌", "ok perfecto"], ["🙏", "gracias rezo por favor pray thanks"], ["🙌", "celebra manos arriba raise"], ["👏", "aplauso clap bravo"], ["🤝", "trato acuerdo handshake mano"], ["💪", "fuerza musculo strong"], ["✋", "alto hand mano"], ["🤚", "mano back"], ["👋", "hola adios wave saludo"], ["✌️", "paz victoria peace"], ["🤞", "suerte cruzados fingers crossed"], ["🤟", "te amo love you"], ["🫰", "corazon coreano dedos finger heart amor kpop"], ["🤙", "llamame call me"], ["👈", "izquierda left"], ["👉", "derecha right"], ["👆", "arriba up"], ["👇", "abajo down"], ["☝️", "uno arriba point"], ["✍️", "escribir write firma"], ["🙇", "reverencia bow disculpa"], ["🤷", "no se shrug"], ["🤦", "facepalm vergüenza"],
  ] },
  { c: "Corazones", items: [
