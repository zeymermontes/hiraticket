...
export const ICONS: Record<string, IconFn> = {
  ...
  mute: () => <>{P("M18 8.5a6 6 0 1 0-12 0c0 6-2.5 7.5-2.5 7.5h17S18 14.5 18 8.5ZM10 19a2 2 0 0 0 4 0")}{P("M3.5 3.5 20.5 20.5")}</>,
  at: () => <>{P("M16 12a4 4 0 1 0-1.2 2.85M16 8v4.5a2.5 2.5 0 0 0 5 0V12a9 9 0 1 0-3.5 7.1")}</>,
  grip: () => <>{P("M9 6h.01M9 12h.01M9 18h.01M15 6h.01M15 12h.01M15 18h.01")}</>,
