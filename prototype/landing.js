...
(function () {
  ...
  var DICT = {
    es: {
      ...
      trust1: 'Sin tarjeta', trust2: 'API oficial de WhatsApp Business', trust3: 'Cancela cuando quieras',
      ...
      foot_privacy: 'Privacidad', foot_terms: 'Términos', foot_delete: 'Eliminación de datos', foot_made: 'Hecho en México 🇲🇽',
      foot_note: 'Integración oficial con la API de WhatsApp Business (Meta).',
    ...
    en: {
      ...
      trust1: 'No credit card', trust2: 'Official WhatsApp Business API', trust3: 'Cancel anytime',
      ...
      foot_privacy: 'Privacy', foot_terms: 'Terms', foot_delete: 'Data deletion', foot_made: 'Made in Mexico 🇲🇽',
      foot_note: 'Official integration with the WhatsApp Business API (Meta).',
